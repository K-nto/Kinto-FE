export const KINTO_SERVICE_URL =
  process.env.KINTO_SERVICE_URL ?? "http://localhost:3000";
export const KINTO_NODES_URL =
  process.env.KINTO_NODES_URL ?? "http://localhost:3001";
